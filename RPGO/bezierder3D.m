function [db,db1] = bezierder3D(B,r,t)
% Opis:
...
matrikaDz = decasteljau(B(:,3),t(i));
db(i,:) = factorial(n-1) /(factorial(n-r-1)) * deljenaDifTocke([matrikaDx(1:r+1,n-r),matrikaDy(1:r+1,n-r),matrikaDz(1:r+1,n-r)],r,1);
